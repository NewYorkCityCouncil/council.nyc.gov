<div class="container" style="padding: 2rem 0;">
    <div class="row">
        <div class="columns livestream-section">
            <h2>LIVE VIDEO FEED</h2>
            <div class="row" style="border-top: 1.5px #58595B solid; padding-top: 30px;">
                <div class="columns">
                    <div class="tabs-content" data-tabs-content="live-videos-tabs" style="border:0;">
                        ...
                        <!-- <div class="tabs-panel" data-auto-focus="true" id="virtual-room-1" style="padding:0;">
                            <div class="flex-video widescreen" style="margin-bottom:0;">
                                ...
                                <script type="text/javascript" data-embed_id="ls_embed_1591111682" src="https://livestream.com/assets/plugins/referrer_tracking.js"></script></div>
                        </div>
                        <div class="tabs-panel" data-auto-focus="true" id="virtual-room-2" style="padding:0;">
                            <div class="flex-video widescreen" style="margin-bottom:0;">
                                ...
                                <script type="text/javascript" data-embed_id="ls_embed_1591111981" src="https://livestream.com/assets/plugins/referrer_tracking.js"></script></div>
                        </div>
                        <div class="tabs-panel" data-auto-focus="true" id="virtual-room-3" style="padding:0;">
                            <div class="flex-video widescreen" style="margin-bottom:0;">
                                ...
                                <script type="text/javascript" data-embed_id="ls_embed_1591112063" src="https://livestream.com/assets/plugins/referrer_tracking.js"></script></div>
                        </div>
                        <div class="tabs-panel" data-auto-focus="true" id="virtual-room-4" style="padding:0;">
                            <div class="flex-video widescreen" style="margin-bottom:0;">
                                ...
                                <script type="text/javascript" data-embed_id="ls_embed_1591112206" src="https://livestream.com/assets/plugins/referrer_tracking.js"></script></div>
                        </div>
                        <div class="tabs-panel" data-auto-focus="true" id="virtual-room-5" style="padding:0;">
                            <div class="flex-video widescreen" style="margin-bottom:0;">
                                ...
                                <script type="text/javascript" data-embed_id="ls_embed_1591112291" src="https://livestream.com/assets/plugins/referrer_tracking.js"></script></div>
                        </div>
                        <div class="tabs-panel" data-auto-focus="true" id="virtual-room-6" style="padding:0;">
                            <div class="flex-video widescreen" style="margin-bottom:0;">
                                ...
                                <script type="text/javascript" data-embed_id="ls_embed_1591112374" src="https://livestream.com/assets/plugins/referrer_tracking.js"></script></div>
                        </div>
                ...
                <div class="columns live-stream-tabs-column">
                    <h4 class="sans-serif subheading">Select a stream:</h4>
                        <ul class="tabs" data-tabs id="live-videos-tabs" style="position: relative; display:inline-flex; overflow-x: scroll; width:100%;">
                            <li class="tabs-title" style="text-align:center; padding: 0.7rem; background-color:#23417D;"><span style="display: block; font-size: 14pt; font-family: 'Gotham-Bold'; line-height: 1; color: #FFF; text-decoration: underline;">SELECT A STREAM:</span></li>
                            <li class="tabs-title is-active" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#location-chambers" aria-selected="true"><span class="show-for-medium">CITY HALL/</span><strong>COUNCIL CHAMBERS</strong></a></li>
                            <li class="tabs-title" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#location-committee-room"><span class="show-for-medium">CITY HALL/</span><strong>CMTE ROOM</strong></a></li>
                            <li class="tabs-title" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#location-14th-floor"><span class="show-for-medium">250 BWAY/</span><strong>14th FL ROOM</strong></a></li>
                            <li class="tabs-title" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#location-16th-floor"><span class="show-for-medium">250 BWAY/</span><strong>16th FL ROOM</strong></a></li>
                            <!--<li class="tabs-title" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#virtual-room-1"><strong>Virtual Room 1</strong></a></li>-->
                            <!--<li class="tabs-title" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#virtual-room-2"><strong>Virtual Room 2</strong></a></li>-->
                            <!--<li class="tabs-title" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#virtual-room-3"><strong>Virtual Room 3</strong></a></li>-->
                            <!--<li class="tabs-title" style="text-align:center; padding: 0.7rem; flex-grow:1;"><a href="#virtual-room-4"><strong>Virtual Room 4</strong></a></li>-->
