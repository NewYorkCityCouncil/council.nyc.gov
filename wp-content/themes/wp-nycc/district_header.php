      ...
      <div class="image-overlay">
        <div class="row">
          <div class="columns clearfix">
            <h2 class="image-overlay-text district-number"><a href="<?php echo esc_url( network_site_url() ); ?>district-<?php echo get_option('council_district_number'); ?>/">District&nbsp;<?php echo get_option('council_district_number'); ?></a></h2>
            <h2 class="image-overlay-text district-member"><a href="<?php echo site_url(); ?>/"><?php echo get_option('council_member_name'); ?></a></h2>
