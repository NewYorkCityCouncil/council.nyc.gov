...
--------------------------------------------------*/
jQuery('a:not([href*="newyorkcitycouncil.github.io/"]):not([href*="council.nyc/"]):not([href*="legistar.council.nyc.gov/"]):not([href*="laws.council.nyc.gov/"]):not([href*="www.nyc.gov/"]):not([href^="#"]):not([href^="/"])').filter(function () {
  return this.hostname && this.hostname.split(".").slice(-3).join(".") !== location.hostname;
}).click(function (e) {
