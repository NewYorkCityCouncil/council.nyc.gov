...
<script>
  ...
  addresslookup.onAdd = function (map) {
    ...
    div.innerHTML = '<form aria-hidden="true" id="addresslookup"><input id="mapAddress" type="text" placeholder="Street Address, Borough"><button type="submit" class="dashicons-before dashicons-search"><span class="show-for-sr">Search</span></button></form><div id="addresslookup-error" class="addresslookup-error"></div>';
    return div;
  };
