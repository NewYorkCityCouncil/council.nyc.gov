...
// Hide admin stuff
function remove_compliance_menus(){
...
add_action( 'admin_menu', 'remove_compliance_menus' );

// Remove admin bar links
function remove_compliance_admin_bar_links() {
    global $wp_admin_bar;
...
add_action( 'wp_before_admin_bar_render', 'remove_compliance_admin_bar_links' );
