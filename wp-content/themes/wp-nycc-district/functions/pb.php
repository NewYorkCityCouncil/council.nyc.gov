...
function nycc_pb_ballot_item_post_type() {
  ...
  register_taxonomy( 'pbtags',
    ...
    array('hierarchical' => false,
      'labels' => array(
        'name' => __( 'PB Tags', 'nycc' ),
        'singular_name' => __( 'PB Tag', 'nycc' ),
        'search_items' =>  __( 'Search PB Tags', 'nycc' ),
        'all_items' => __( 'All PB Tags', 'nycc' ),
        'edit_item' => __( 'Edit PB Tag', 'nycc' ),
        'update_item' => __( 'Update PB Tag', 'nycc' ),
        'add_new_item' => __( 'Add New PB Tag', 'nycc' ),
        'new_item_name' => __( 'New PB Tag Name', 'nycc' ),
        'parent_item'       => __( 'Parent PB Tag' ),
        'parent_item_colon' => __( 'Parent PB Tag:' ),
        'menu_name'         => __( 'PB Tags' ),
      ),
  ...
  register_taxonomy( 'pbcycle',
    array('nycc_pb_ballot_item'),
    array('hierarchical' => false,
      'labels' => array(
        'name' => __( 'PB Cycles', 'nycc' ),
        'singular_name' => __( 'PB Cycle', 'nycc' ),
        'search_items' =>  __( 'Search PB Cycles', 'nycc' ),
        'all_items' => __( 'All PB Cycles', 'nycc' ),
        'edit_item' => __( 'Edit PB Cycle', 'nycc' ),
        'update_item' => __( 'Update PB Cycle', 'nycc' ),
        'add_new_item' => __( 'Add New PB Cycle', 'nycc' ),
        'new_item_name' => __( 'New PB Cycle Name', 'nycc' ),
        'parent_item'       => __( 'Parent PB Cycle' ),
        'parent_item_colon' => __( 'Parent PB Cycle:' ),
        'menu_name'         => __( 'PB Cycles' ),
        'choose_from_most_used' => __( 'Choose from the most used cycles' ),
      ),
      'show_admin_column' => true,
      'show_ui' => true,
      'query_var' => true,
